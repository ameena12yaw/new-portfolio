...
const projects = [
  {
    ...
    category: "frontend",
    title: "Project 1",
    description: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit, harum.",
    stack: [
      { name: "Html 5" },
      { name: "Css 3 "},
      { name: "Javascript "},
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460] flex flex-col xl:justify-between order-2 xl:order-none">
              <div className="flex flex-col gap-[30px] h-[50%]">
                <div className="text-5xl font-extrabold leading-none text-transparent text-outline">
                  {project.num}
                </div>
